...
%% reading KT3DMoSeg_TwoView dataset

dataPath = fullfile([pwd '/Datasets/KT3DMoSeg_TwoView/']); 
...
for jj =1:length(folderNames)
    ...
    DataCurr = load([dataPath,sequencename]);
    y = DataCurr.y; G = DataCurr.G-double(out);
